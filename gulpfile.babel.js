...
const winstallerConfig = {
  ...
  // TODO: Fix this ico URL
  // iconUrl: 'https://somewhere.com/icon.ico',
  ...
  // TODO: Read DEV above ^^
  // remoteReleases: 'https://github.com/Project-Shade/Shade-Client',
};
...
gulp.task('build', ['external', 'utility-js', 'transpile', 'images', 'less',
                    'fonts', 'html']);
