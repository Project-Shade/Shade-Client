...
const template = [
  ...
  },
  {
    ...
    submenu: [
      ...
      {
        label: 'Issues',
        click: () => shell.openExternal('https://github.com/Project-Shade/Shade-Client/issues'),
      },
      {
        label: 'Donate',
      ...
      {
        label: 'Learn More',
        click: () => shell.openExternal('https://github.com/Project-Shade/Shade-Client'),
      },
    ],
  },
];
  ...
  template.unshift({
    ...
    submenu: [
      ...
      },
      {
        label: 'Preferences',
        accelerator: 'Command+,',
        click: () => Emitter.sendToWindowsOfName('main', 'settings'),
      },
      {
        type: 'separator',
      },
